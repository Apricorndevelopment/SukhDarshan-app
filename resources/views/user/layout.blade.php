                        ...
                        <div class="dropdown">
                            <button class="d-flex justify-content-center align-items-center rounded-circle"
                                ...
                                @if (Auth::user()->profile_image)
                                    <img src="{{ asset(Auth::user()->profile_image) }}" width="100"
                                        height="100" class="w-40-px h-40-px object-fit-cover rounded-circle"
                                        alt="Profile Image">
                                @else
                                    <img src="{{ asset('default-user.png') }}" width="100" height="100"
                                        class="rounded-circle me-3" alt="Default Profile Image">
                                @endif
                            </button>
                            <div class="dropdown-menu to-top dropdown-menu-sm">
                                <div
                                    ...
                                    <div>
                                        <h6 class="text-lg text-primary-light fw-semibold mb-2">
                                            {{ Auth::user()->name }}</h6>
                                        <span
                                            class="text-secondary-light fw-medium text-sm">{{ Auth::user()->role }}</span>
                                    </div>
                                ...
                                <ul class="to-top-list">
                                    <li>
                                        ...
                                        <button id="toggleEdit" class="btn  mb-3">Edit Profile</button>
                                    </li>
