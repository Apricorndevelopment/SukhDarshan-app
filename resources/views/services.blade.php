...
@section('container')
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="ayur-bread-content">
                            ...
                            <div class="ayur-bread-list">
                                ...
                                <span class="ayur-active-page">Service</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!------------- Why Section start ----------->
    <div class="ayur-bgcover ayur-why-sec ayur-why-singleser">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
    ...
    <div class="ayur-bgcover ayur-pricinplan-sec">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="ayur-heading-wrap ayur-trenproduct-head">
                        <h5>Pricing Plan</h5>
                        <h3>Special Plan</h3>
                    </div>
                </div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="ayur-pricing-sec">
                        <div class="ayur-pricing-head">
                            <div class="ayur-price-meta">
                                <h3>Basic Plan
                                    <span class="ayur-name-shape"></span>
                                </h3>
                            </div>
                            <div class="ayur-pricing-pricevalue">
                                <h4>$8<span> / Month</span></h4>
                            </div>
                        </div>
                        <div class="ayur-price-list">
                            <ul>
                                <li>
                                    <p>1 Product Free</p>
                                </li>
                        ...
                        <div class="ayur-price-btn">
                            <a href="javascript:void(0)" class="ayur-btn">Buy Plan</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
